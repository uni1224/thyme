...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<sassc>.freeze, [">= 2.0.0".freeze])
  s.add_runtime_dependency(%q<autoprefixer-rails>.freeze, [">= 5.2.1".freeze])
  ...
  s.add_development_dependency(%q<capybara>.freeze, ["~> 3.6".freeze])
  s.add_development_dependency(%q<poltergeist>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<sassc-rails>.freeze, [">= 2.0.0".freeze])
  ...
  s.add_development_dependency(%q<sprockets-rails>.freeze, [">= 2.1.3".freeze])
